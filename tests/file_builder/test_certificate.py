...
from trustpoint_core.file_builder.certificate import (
    CertificateArchiveFileBuilder,
    CertificateFileBuilder,
)
...
@pytest.mark.parametrize(
    "file_format, archive_format", product(CERTIFICATE_FORMATS, ARCHIVE_FORMATS)
)
def test_certificate_archive_file_builder(
    mock_certificate_collection_serializer, file_format, archive_format
):
