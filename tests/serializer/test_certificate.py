...
def test_certificate_collection_serializer_as_certificate_serializer_list(
    pem_encoded_cert,
):
...
def test_certificate_collection_serializer_extend(pem_encoded_cert):
    ...
    another_serializer = CertificateCollectionSerializer(
        [pem_encoded_cert, pem_encoded_cert]
    )
...
def test_certificate_collection_serializer_certificate_serializer_iterator(
    pem_encoded_cert,
):
